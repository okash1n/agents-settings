...
DEFAULT_COMPATIBILITY = "codex,copilot"
...
- `compatibility` は `codex,copilot` にする。
...
def default_output_root() -> Path:
    return Path("~/ghq/github.com/okash1n/agents-settings/skills").expanduser()
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="Output root directory (default: ~/ghq/github.com/okash1n/agents-settings/skills)",
    )
    parser.add_argument(
        "--resources",
        default="",
